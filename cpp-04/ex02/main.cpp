...
/*   Updated: 2024/11/29 14:26:29 by alsiavos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// std::cout << "\n=== Tentative de créer un Animal directement (doit échouer) ===" << std::endl;
    // Animal test; // Erreur de compilation : classe abstraite
